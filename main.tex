...
\begin{document}
	...
	\begin{section}{\sectitle{\faStar}{Experience}}
		\begin{tabularx}{\linewidth}{@{}p{1.4cm} | X r}
				...
				Developed, designed and deployed automation of API secret rotation in \tech{Go} for various service providers to increase the security, decrease manual work and eliminate human error. Led the team behind this project and done code reviews to eliminate future flaws and bad design practices.
				\vspace{0.2ex}
			}
