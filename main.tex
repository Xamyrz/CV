...
\begin{document}
	...
	\begin{section}{\sectitle{\ \faUser}{\ Bio}}
		I am a current \nth{3} Year student of Computer Science in University College Dublin. Huge interest in computer hardware and programming with languages ranging from Scheme to Python. Fluent in English and Polish. \\
	\end{section}
	\vspace{-3.5mm}
	...
	\newcommand{\education}[6]{
		...
		\begin{tabularx}{\linewidth}{@{}l  X}
			...
			\textsc{programming languages} & JavaScript), NodeJS, PHP, Java, C, C++, SQL(MySQL), Python, Scheme, Scala3 \\
	...
	\begin{section}{\sectitle{\faStar}{Experience}}
		\begin{tabularx}{\linewidth}{@{}p{1.4cm} | X r}
				\experience{05.2021}{present}{Part-time Internship at OpenLitterMap}{https://openlittermap.com/}{OpenLitterMap}{
				...
				\experience{05.2021}{08.2021}{Part-time Internship at Measuresoft}{http://measuresoft.com/}{Measuresoft}{
	...
	\begin{section}{\sectitle{\faClipboard}{Projects}}
		\begin{tabularx}{\linewidth}{@{}p{1.4cm} | X r}
				...
				Developed a board game with college class mate in C. It's a simple board game for up to 6 playes. The game is played in terminal only. 
				\vspace{0.2ex}
			}
		\end{tabularx}
		\\ \\
