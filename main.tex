...
\begin{document}
	...
	\begin{section}{\sectitle{\faStar}{Experience}}
		\begin{tabularx}{\linewidth}{@{}p{1.4cm} | X r}
				...
				Translated the whole website to Polish, Fixed a lot of minor bugs, created \tech{Artisan} scripts to migrate data from \tech{SQL} to \tech{Redis} and scripts to populate the database with dummy data for development purposes. OpenLitterMap is developed with \tech{Laravel} and \tech{ReactNative}.
				\vspace{0.2ex}
			}
